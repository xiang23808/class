 ...
 * Generated for Laravel 5.5.50 on 2023-08-15 07:26:56.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function content($uri, $content, $options = array())
        {
         ...
         * @static 
         */ 
        public static function component($uri, $component, $data = array(), $options = array())
        {
...
namespace Encore\Admin\Facades { 
    ...
    class Admin {
        ...
        {
            return \Encore\Admin\Admin::guard();
        }
         ...
         * @static 
         */ 
        public static function component($component, $data = array())
        {
